                ...
                <div class="hero-inner">
                    ...
                    <div class="container">
                        <div class="hero-style1">
                            ...
                            <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.6s"> Spotless Clothes, Effortless Service</h1>
                            <p class="hero-text text-white" data-ani="slideinup" data-ani-delay="0.7s">Freshness Delivered, Confidence Restored.</p>
                            <div class="btn-group" data-ani="slideinup" data-ani-delay="0.9s">
                                <a href="#" class="th-btn style2" data-ani="slideinup" data-ani-delay="0.9s">Wash My Clothes
                                    </a>
                                <a href="{{ route('contactUs')}}" class="th-btn style5" data-ani="slideinup" data-ani-delay="0.9s">Contact
                                    Us</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    ...
                    <div class="container">
                        <div class="hero-style1">
                            <span class="sub-title style1" data-ani="slideinup" data-ani-delay="0.5s">We Clean, You Shine</span>
                            <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.6s">Clean Clothes, Happy Life!</h1>
                            <p class="hero-text text-white" data-ani="slideinup" data-ani-delay="0.7s">Your Clothes Deserve the Best — Let Us Care for Them</p>
                            <div class="btn-group" data-ani="slideinup" data-ani-delay="0.9s">
                                <a href="#" class="th-btn style2" data-ani="slideinup" data-ani-delay="0.9s">Wash My Clothes
                                </a>
                                <a href="{{ route('contactUs')}}" class="th-btn style5" data-ani="slideinup" data-ani-delay="0.9s">Contact
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    ...
                    <div class="container">
                        <div class="hero-style1">
                            <span class="sub-title style1" data-ani="slideinup" data-ani-delay="0.5s">We Clean, You Shine</span>
                            <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.6s">We Take Care of Your Clothes, You Take Care of Life! </h1>
                            <p class="hero-text text-white" data-ani="slideinup" data-ani-delay="0.7s">From Stains to Shine: Experience the Power of Clean!</p>
                            <div class="btn-group" data-ani="slideinup" data-ani-delay="0.9s">
                                <a href="#" class="th-btn style2" data-ani="slideinup" data-ani-delay="0.9s">Wash My Clothes
                                </a>
                                <a href="{{ route('contactUs')}}" class="th-btn style5" data-ani="slideinup" data-ani-delay="0.9s">Contact
...
<p class="about-desc">At catchyTat, we offer a comprehensive range of premium laundry services including wash and fold, dry cleaning, professional ironing, stain removal, and expert care for delicate fabrics and special garments. Trust us to deliver exceptional results every time, with convenient pickup and delivery for your convenience.</p>
                    ...
                    <div class="btn-group mt-30 justify-content-start">
                        <a href="#" class="th-btn">Wash My Clothes</a>
                    </div>
                </div>
            </div>
        </div>
...
Feature Area
==============================-->
<div class="features-area position-relative overflow-hidden bg-top-center space" >
    <div class="container">
        <div class="row">
            <div class="col-xl-9">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="cta-group justify-content-lg-end justify-content-center">
                        <a href="#" class="th-btn style2">Wash my Clothes</a>
                        <a href="#" class="th-btn style3">Contact Us Now</a>
                    </div>
                </div>
            </div>
        </div>
...
Testimonial Area
==============================-->
<section class="testi-area " id="testi-sec" data-bg-src="#">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="price-card ">
                    ...
                    <div class="price-card_content">
                        ...
                        <a href="{{route('serviceOrder')}}" class="th-btn style3">Choose Packages</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="price-card active">
                    ...
                    <div class="price-card_content">
                        ...
                        <a href="price.htm{{route('serviceOrder')}}" class="th-btn style3">Choose Packages</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="widget widget_nav_menu footer-widget">
                        ...
                        <div class="menu-all-pages-container">
                            <ul class="menu style2">
                                ...
                                <li><a href="{{route('serviceOrder')}}">Carpet Rinse</a></li>
                                <li><a href="{{route('serviceOrder')}}">Pure Care Laundering</a></li>
                                <li><a href="{{route('serviceOrder')}}">Laundry Service</a></li>
